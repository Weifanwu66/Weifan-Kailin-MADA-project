...
ggsave("time_v_hospitalization_pathogen_type.png", path = image_path)
...
## Save Graph
ggsave("pathogen_type_etiology_v_hospitalizations.png", path = image_path)
...
ggsave("bacterial_etiology_v_hospitalization_frequency.png", path = image_path)
...
ggsave("Food_type_v_hospitalization.png", path = image_path)
...
ggsave("Location_v_hospitalization.png", path = image_path)
...
## Save Graph
ggsave("time_v_illness_pathogen_type.png", path = image_path)
...
## Save Graph
ggsave("pathogen_type_etiology_v_illness.png", path = image_path)
...
# Save Graph
ggsave("bacterial_etiology_v_outbreak_frequency.png", path = image_path)
...
# Save Graph
ggsave("food_type_v_illness_frequency.png", path = image_path)
...
# Save Graph
ggsave("Location_v_Illness.png", path = image_path)
