...
ggplot(training_data_final %>% 
  ...
  labs(x = "Pathogen Type", y = "Hospitalizations", 
       title = "Stacked Bar Chart of Hospitalizations by Pathogen Type and Etiology")
...
## Project Total Hospitalizations onto State Map
...
ggplot(analysis_data_final %>% 
  ...
  geom_bar() + 
  labs(x = "Bacteria", y = "Cases", title = "Bar Chart of Bacteria Frequency")+
  coord_flip()
