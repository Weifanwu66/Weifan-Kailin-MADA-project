...
```
#outcome: hospitalization/illness
#predictors:year/month/Food/State/Location
#logistic regression models
#visualizaiton: 
linegraphs for years/month and illness, group by species/IFSAC code
boxplot/violin for top 10 food/state/location with hospitalization and illness
tables for IFSAC/ pathogens 
