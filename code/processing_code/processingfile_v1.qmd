...
#categorize everything else other than vectors into other
```{r}
...
training_data_final=training_data_fin%>%
  drop_na()
analysis_data_final=analysis_data_fin%>%
  drop_na()
```
...
```{r}
processeddata1<- training_data_final
processeddata2<-analysis_data_final
```
