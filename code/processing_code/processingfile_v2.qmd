...
```{r, loaddata}
data_location<-here("data","raw_data","NationalOutbreakPublicDataTool.xlsx")
rawdata2=read_excel(data_location)
...
```{r, exploredata, fig.height=8, fig.width=8}
glimpse(rawdata2)
summary(rawdata2)
head(rawdata2)
skim(rawdata2)
plot_na_pareto(rawdata2)
```
...
```{r, cleandata1,fig.height=8, fig.width=8}
d2=rawdata2%>%
