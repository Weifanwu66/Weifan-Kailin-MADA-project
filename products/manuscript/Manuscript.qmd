...
Afterwards, we built regression models using these predictors and health outcomes; we intend to implement machine learning to train a model to predict health outcomes using the Kaggle dataset for the CDC NORS data.
