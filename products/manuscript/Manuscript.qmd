...
The first dataset was uploaded onto Kaggle in 2017 and contains data from the Centers for Disease Control and Prevention (CDC) on foodborne disease outbreaks from 1998 to 2015 @centersfordiseasecontrolandprevention2017.
There are 12 variables and 16,950+ observations.

The second dataset was collected from National Outbreak Reporting System (NORS), Centers for Disease Control and Prevention (CDC) website.
